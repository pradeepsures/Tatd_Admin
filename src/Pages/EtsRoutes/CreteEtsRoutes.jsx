...
import { createEtsRouteApi } from "../../Services/EtsRouteApi";

const CreateEtsRoute = () => {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      const res = await createEtsRouteApi(formData);
      ...
      <div className="mt-6 bg-white p-6 w-full rounded-xl shadow-xl">
        <form onSubmit={handleSubmit}>
          ...
          {formData.stoppages.map((stop, index) => (
            <div
              key={index}
              className="border p-4 mt-4 rounded-xl bg-gray-50"
            >
